...
import com.tomcz.mvi.internal.ChannelEffectProcessor
import com.tomcz.mvi.internal.ChannelStateEffectProcessor
...
fun <EV : Any, ST : Any, PA : Intent<ST>, EF : Any> CoroutineScope.stateEffectProcessor(
    ...
    ChannelStateEffectProcessor(this, defViewState, prepare, prepareEffect, effects, statesEffects)

fun <EV : Any, EF : Any> CoroutineScope.effectProcessor(
    prepare: (suspend (Effects<EF>) -> Unit)? = null,
    effects: suspend (Effects<EF>, EV) -> Unit = { _, _ -> },
): EffectProcessor<EV, EF> = ChannelEffectProcessor(this, prepare, effects)
